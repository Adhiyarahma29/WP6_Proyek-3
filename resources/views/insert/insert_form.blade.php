                            ...
                            <div class="slide" id="slide3" style="display: none;">
                                ...
                                <div id="riwayat-pengalaman-container">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control organisasi" name="organisasi[]"
                                                required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control penerbit" name="penerbit[]"
                                                required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="sertifikat" type="file" class="form-control"
                                                name="sertifikat[]" accept=".pdf, .doc, .docx, .jpg, .png" multiple
                                                required>
                            ...
                            <div class="slide" id="slide4" style="display: none;">
                                ...
                                <div id="pekerjaan-container">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control perusahaan"
                                                name="bidang_pekerjaan[]" required>
                                        </div>
...
<label for="gelar" class="col-md-4 col-form-label text-md-end">{{ __('Gelar Depan:') }}</label>
<div class="col-md-6">
