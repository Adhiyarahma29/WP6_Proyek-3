...
class addcvController extends Controller
{
    ...
    public function storeData1(Request $request)
    {
        ...
        return redirect('slide2')->with('success', 'Data dari Form Slide 1 berhasil disimpan');
    }
    ...
    public function storeData2(Request $request)
    {
        ...
        // Redirect atau tampilkan pesan sukses
        return redirect('/form-pengisian-data')->with('success', 'Data dari Form Slide 2 berhasil disimpan');
    }
